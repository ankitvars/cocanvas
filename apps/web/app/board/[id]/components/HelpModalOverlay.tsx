        ...
        <div style={{ display: 'flex', gap: '24px', flexDirection: 'row', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: '1 1 280px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {[
                { label: 'Selection tool', key: 'Shift + V (or 1)' },
                { label: 'Rectangle tool', key: 'Shift + R (or 2)' },
                { label: 'Diamond tool', key: 'Shift + D (or 3)' },
                { label: 'Ellipse tool', key: 'Shift + O (or 4)' },
                { label: 'Arrow tool', key: 'Shift + A (or 5)' },
                { label: 'Line tool', key: 'Shift + L (or 6)' },
                { label: 'Draw (Pen)', key: 'Shift + P (or 7)' },
                { label: 'Text tool', key: 'Shift + T (or 8)' },
                { label: 'Insert Image', key: 'Shift + 9' },
                { label: 'Eraser tool', key: 'Shift + E (or 0)' },
